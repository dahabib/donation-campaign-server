...
-- AddForeignKey
ALTER TABLE "collections" ADD CONSTRAINT "collections_campaign_id_fkey" FOREIGN KEY ("campaign_id") REFERENCES "donations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "collections" ADD CONSTRAINT "collections_donated_by_fkey" FOREIGN KEY ("donated_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
